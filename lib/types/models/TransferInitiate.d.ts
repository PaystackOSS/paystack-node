...
export declare function TransferInitiateFromJSON(json: any): TransferInitiate;
export declare function TransferInitiateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransferInitiate;
export declare function TransferInitiateToJSON(value?: TransferInitiate | null): any;
