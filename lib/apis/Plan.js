 ...
 *
 */
class Plan extends runtime_1.BaseAPI {
    /**
     * Create Plan
     */
    create(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.amount === null || requestParameters.amount === undefined) {
                throw new runtime_1.RequiredError('amount', 'Required parameter amount was null or undefined when calling create.');
            }
            if (requestParameters.interval === null || requestParameters.interval === undefined) {
                throw new runtime_1.RequiredError('interval', 'Required parameter interval was null or undefined when calling create.');
            }
